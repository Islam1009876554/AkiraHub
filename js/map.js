 ...
 * map.js
 * 
 * Базовая инициализация карты Leaflet для главной страницы.
 * Функции:
 * - Создание карты с маркерами чудес Казахстана
 * - Настройка иконок для природных и культурных достопримечательностей
 * - Создание попапов с информацией о каждом чуде
 * - Добавление легенды и элементов управления
 */
let map;
