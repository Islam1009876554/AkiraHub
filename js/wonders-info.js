 ...
 * wonders-info.js
 * 
 * Подробная информация о чудесах Казахстана и функции для модальных окон.
 * Содержит расширенные описания, изображения, местоположения и особенности
 * каждого чуда, а также функции для отображения этой информации
 * в модальных окнах при взаимодействии пользователя.
 */
